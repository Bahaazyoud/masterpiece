...
<body>
    ...
    <div class="landing">
        ...
        <div class="landing-info">
            ...
            <div class="logo">
                <!-- ICON LOGO VIKINGER -->
                <img class="icon-logo-vikinger" src="./img/landing/logo.png"
            ...
            <!-- LANDING INFO TITLE -->
            <h1 class="landing-info-title">UNI</h1>
            <!-- /LANDING INFO TITLE -->

            <!-- LANDING INFO TEXT -->
            <p class="landing-info-text">
                The next generation social network &amp; community!Connect with
                university students to solve difficult problems in various subjects
            </p>
            <!-- /LANDING INFO TEXT -->
